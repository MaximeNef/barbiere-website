...
const Avendre = ({ finalBiens, withoutDuplicates }) => {
  ...
  const filteredList = (() => {
    ...
    // Si aucun bien dispo/sous option, fallback sur les vendus pour ce code postal
  ...
  return (
    <NavPage current='Nos biens'>
      ...
      <FilterProduct
        pages={finalBiens.filter((bien) => bien.type === "vendre")}
