          ...
          <Link href={link.href} key={link.page} passHref>
            {link.page == current ? (
              <a
                ...
                className='text-xl font-light font-medium tracking-wide rounded-full pl-6 py-4 bg-[#41B8B8]/10 w-full'
              >
                <Flex justify='start'>
              ...
              <a
                onClick={handelClick2}
                className='text-xl font-light font-medium tracking-wide pl-6  py-2'
              >
                <Flex>
                  <MyImage source={link.src} w={20} h={20} />

                  <Flex justify='start'>
                    <p className='ml-5 text-center text-[#0a2629]'>
                      {link.page}
                    </p>
                  </Flex>
                </Flex>
