...
const CardChiffre = (props) => {
  return (
    <Container className='rounded-[20px] p-5 bg-white shadow-cardChiffre  border-2 mx-6 relative mb-6 mt-8'>
      ...
      <Container className=' font-light text-[17px] leading-[21px] text-[#646464] ml-[10px] text-center md:text-center px-8'>
        {props.txt}
      </Container>
    </Container>
  );
